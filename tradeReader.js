...
class TradeReader {
    ...
    Help() {
        return "\nreader <start/stop> - Logs IEC exchange chat messages to a file. Check top of file for config options included JSON output, low stock warning output, and CSV."
    }
}
